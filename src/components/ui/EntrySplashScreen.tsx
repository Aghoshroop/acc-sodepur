      ...
      <AnimatePresence>
        {splashState !== 'done' && (
          <>
            ...
            <div className="fixed inset-0 z-[100] pointer-events-none hidden md:flex">
            ...
            <motion.div 
              className="fixed inset-0 z-[100] pointer-events-none flex md:hidden bg-carbon-black flex-col justify-center px-6"
              animate={splashState === 'shuttering' ? { opacity: 0, scale: 1.05 } : { opacity: 1, scale: 1 }}
              transition={{ duration: 0.6, ease: [0.76, 0, 0.24, 1] }}
            >
              <div className="relative z-10 flex flex-col items-start w-full">
                {/* 
                  Using word-level animation for performance and strict vw sizing to prevent 
                  overflow on tiny screens (< 300px), maintaining authentic desktop aesthetic 
                  but in a vertically stacked poster format. 
                */}
