        ...
        <div className="relative w-full">
          ...
          <section className="relative z-30 w-full min-h-screen pt-32 pb-16 bg-carbon-black text-chalk-white border-b border-chalk-white/10">
            <div className="absolute inset-0 z-0 overflow-hidden">
               <Image src="/images/SaveClip.App_616937500_18553197997031549_5960353073541653553_n.jpg" alt="Rudra Pratim Roy" fill className="object-cover object-[100%_30%] scale-125 -translate-x-[10%] translate-y-[10%] transition-all duration-700 opacity-80" />
